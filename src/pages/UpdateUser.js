...
function UpdateUser({ user }) {
	...
	const [newName, setNewName] = useState(user && user.user.name);
	const [newPhone, setNewPhone] = useState(user && user.user.cellphone);
	const [newDate, setNewDate] = useState(user && user.user.birthDate);
	const [newPass, setNewPass] = useState("");
	const ema = user && user.user.email
